...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(lblTitulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 40, 250, 110));

        lbltexto.setFont(new java.awt.Font("Yu Gothic UI Semibold", 0, 16)); // NOI18N
        lbltexto.setForeground(new java.awt.Color(255, 255, 255));
        lbltexto.setText("Aun no tienes cuenta?");
        jPanel1.add(lbltexto, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 410, 170, 20));

        lblUsuario.setBackground(new java.awt.Color(255, 255, 255));
        lblUsuario.setFont(new java.awt.Font("Yu Gothic UI Semibold", 0, 18)); // NOI18N
        lblUsuario.setForeground(new java.awt.Color(255, 255, 255));
        lblUsuario.setText("Usuario:");
        jPanel1.add(lblUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 220, 70, 20));

        lblContrasena.setFont(new java.awt.Font("Yu Gothic UI Semibold", 0, 18)); // NOI18N
        lblContrasena.setForeground(new java.awt.Color(255, 255, 255));
        lblContrasena.setText("Contraseña:");
        jPanel1.add(lblContrasena, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 290, -1, -1));
        ...
        jPanel1.add(txtContrasena, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 290, 210, 30));
        ...
        jPanel1.add(btnIngresar, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 350, 160, 30));

        btnRegistrarUsuario.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        btnRegistrarUsuario.setText("Registrate aquí");
        btnRegistrarUsuario.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnRegistrarUsuarioActionPerformed(evt);
            }
        });
        jPanel1.add(btnRegistrarUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 440, 140, 30));
